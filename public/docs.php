...
if ($isAjax && $activeId) {
    ...
    if ($prevDoc || $nextDoc): ?>
      <?php if ($prevDoc): ?>
      <a href="docs.php?id=<?php echo urlencode($prevDoc['id']); ?>" class="docs-nav-btn docs-nav-btn-prev">
      ...
      <?php if ($nextDoc): ?>
      <a href="docs.php?id=<?php echo urlencode($nextDoc['id']); ?>" class="docs-nav-btn docs-nav-btn-next">
          ...
          <?php if ($activeId && isset($indexMap[$activeId])): ?>
            ...
            <nav class="docs-breadcrumb" aria-label="Breadcrumb">
              <div class="docs-breadcrumb-item">
                <a href="docs.php" class="docs-breadcrumb-link">Documentation</a>
              </div>
      ...
      <aside class="docs-sidebar">
        ...
        <div class="docs-sidebar-scroll">
          ...
          <div class="docs-sidebar-view active" id="contentsView">
            ...
            ?>
            <a href="docs.php?id=<?php echo urlencode($f['id']); ?>" class="docs-sidebar-link <?php echo $isActive ? 'active' : ''; ?>" data-doc-name="<?php echo htmlspecialchars($f['relative']); ?>">
