...
<nav class="mobile-menu" id="mobile-menu">
  ...
  <div class="mobile-menu-header">
    <a href="dashboard.php" class="mobile-menu-logo">
  ...
  <div class="mobile-menu-content">
    ...
    <div class="mobile-menu-section">
      <a href="dashboard.php" class="mobile-menu-link <?= $currentPage === 'dashboard.php' ? 'active' : '' ?>">
      ...
      <a href="analytics-dashboard.php" class="mobile-menu-link <?= $currentPage === 'analytics-dashboard.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="inventory-list.php" class="mobile-menu-link <?= $currentPage === 'inventory-list.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="add_item.php" class="mobile-menu-link <?= $currentPage === 'add_item.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="quotations.php" class="mobile-menu-link <?= $currentPage === 'quotations.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="invoicing.php" class="mobile-menu-link <?= $currentPage === 'invoicing.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" stroke="currentColor" stroke-width="2"/>
          <polyline points="14 2 14 8 20 8" stroke="currentColor" stroke-width="2"/>
      ...
      <a href="orders.php" class="mobile-menu-link <?= $currentPage === 'orders.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="projects.php" class="mobile-menu-link <?= $currentPage === 'projects.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="shipping.php" class="mobile-menu-link <?= $currentPage === 'shipping.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="bir-compliance.php" class="mobile-menu-link <?= $currentPage === 'bir-compliance.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" stroke="currentColor" stroke-width="2"/>
          <polyline points="14 2 14 8 20 8" stroke="currentColor" stroke-width="2"/>
      ...
      <a href="fda-compliance.php" class="mobile-menu-link <?= $currentPage === 'fda-compliance.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="notifications.php" class="mobile-menu-link <?= $currentPage === 'notifications.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="chart-of-accounts.php" class="mobile-menu-link <?= $currentPage === 'chart-of-accounts.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M9 5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15" stroke="currentColor" stroke-width="2"/>
          <rect x="9" y="3" width="6" height="4" rx="1" stroke="currentColor" stroke-width="2"/>
      ...
      <a href="journal-entries.php" class="mobile-menu-link <?= $currentPage === 'journal-entries.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="financial-reports.php" class="mobile-menu-link <?= $currentPage === 'financial-reports.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="conversations.php" class="mobile-menu-link <?= $currentPage === 'conversations.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="system-alerts.php" class="mobile-menu-link <?= $currentPage === 'system-alerts.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="docs.php" class="mobile-menu-link <?= $currentPage === 'docs.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobile-menu-section">
      ...
      <a href="profile.php" class="mobile-menu-link <?= $currentPage === 'profile.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="settings.php" class="mobile-menu-link <?= $currentPage === 'settings.php' ? 'active' : '' ?>">
        <svg class="mobile-menu-link-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
