...
<nav class="bottom-nav" id="bottom-nav">
  <a href="dashboard.php" class="bottom-nav-item <?= $currentPage === 'dashboard.php' ? 'active' : '' ?>">
  ...
  <a href="inventory-list.php" class="bottom-nav-item <?= $currentPage === 'inventory-list.php' ? 'active' : '' ?>">
    <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <a href="add_item.php" class="bottom-nav-item bottom-nav-item-fab <?= $currentPage === 'add_item.php' ? 'active' : '' ?>">
  ...
  <a href="notifications.php" class="bottom-nav-item <?= $currentPage === 'notifications.php' ? 'active' : '' ?>">
    <svg class="bottom-nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <a href="profile.php" class="bottom-nav-item <?= $currentPage === 'profile.php' ? 'active' : '' ?>">
